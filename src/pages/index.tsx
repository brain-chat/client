        ...
        <div className={styles.description}>
          ...
          <div>
            <a href="https://vercel.com?utm_source=create-next-app&utm_medium=default-template&utm_campaign=create-next-app" target="_blank" rel="noopener noreferrer">
              By <Image src={BASE_URL + "/vercel.svg"} alt="Vercel Logo" className={styles.vercelLogo} width={100} height={24} priority />
            </a>
          </div>
        </div>

        <div className={styles.center}>
          <Image className={styles.logo} src={BASE_URL + "/next.svg"} alt="Next.js Logo" width={180} height={37} priority />
        </div>
